...
## 📥 Download Openbrowser for Windows
...
6. If you see an `.exe` file, double-click it to start Openbrowser.
7. If Windows asks for permission, choose **Run** or **Yes**.
8. Wait for the browser window to appear.
...
- Check that you extracted the file if it came as a `.zip`
- Right-click the `.exe` and choose **Open**
- Close other browser windows if your PC is low on memory
...
- `Downloads\Openbrowser`
- `Desktop\Openbrowser`
- `Documents\Openbrowser`
...
### Does Openbrowser work on Windows?
